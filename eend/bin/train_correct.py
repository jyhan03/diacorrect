...
parser.add_argument('train_init_sas',
                    help='initialized sas of training set.')
parser.add_argument('dev_init_sas',
                    help='initialized sas of dev set.')
...
from eend.pytorch_backend.train_correct import train
train(args)
