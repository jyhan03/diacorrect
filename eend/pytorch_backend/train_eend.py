...
from eend.pytorch_backend.nnet_eend import TransformerModel, NoamScheduler
from eend.pytorch_backend.diarization_dataset_eend import KaldiDiarizationDataset, my_collate
...
def train(args):
    ...
    if args.model_type == 'Transformer':
        model = TransformerModel(
                idim=Y.shape[1],
                n_blocks=args.transformer_encoder_n_layers,
